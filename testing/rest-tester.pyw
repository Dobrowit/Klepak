...
def generate_data():
    ...
    # Generowanie losowej szerokości geograficznej
    latitude = random.uniform(49.0020432310001, 54.836416667)
    
    # Generowanie losowej długości geograficznej
    longitude = random.uniform(14.1228848600001, 24.1457830750001)
